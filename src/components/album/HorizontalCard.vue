...
<template>
  <div
    class="relative h-[300px] animate-[slideBottomIn_1s] overflow-hidden rounded-3xl bg-sky-400 dark:bg-neutral-800"
  >
    ...
    <img class="h-full w-full object-cover" :src="cover || errorImg" alt="" />
