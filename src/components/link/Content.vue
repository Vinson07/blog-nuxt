...
<template>
  <div
    class="dark:bg-v-bg-dark mx-auto my-6 max-w-6xl animate-[slideUpIn_1s] rounded-md py-7 px-4 shadow-[0_0_1rem_rgba(0,0,0,0.1)] dark:shadow-[0_0_1rem_#000000] md:px-9"
  >
